...
**IP 经验**
- ARM Cortex-M0+ · RISC-V (Serv)
- USB 1.1 Host/Device · SPI · UART · DMA · Timer
- ECC 加密 (DWC_pka)
...
**HelloAgents** — 生产级多 Agent 框架（参与开发）
- OpenAI API 原生 · 子 Agent · 乐观锁 · 熔断器 · Skills 知识体系
...
| 项目 | 描述 |
|------|------|
| [open_usb1.1_host](https://github.com/Johnmc104/open_usb1.1_host) | USB 1.1 主机控制器 + PHY (Verilog) |
| [open_usb1.1_device](https://github.com/Johnmc104/open_usb1.1_device) | USB 1.1 设备控制器 + PHY (Verilog) |
